...
if ( ! function_exists( 'theme_name_theme_supports' ) ) :
function theme_name_theme_supports(){
	...
	register_nav_menus( array(
		'main-menu'   => __( 'Primary menu', 'theme_name' ),
	) );    
}
endif;
add_action('after_setup_theme', 'theme_name_theme_supports');


// Calling Theme files
function theme_name_theme_files(){
    ...
    wp_enqueue_style( 'theme_name-theme-style', get_stylesheet_uri() );
    
    wp_enqueue_style( 'theme_name-theme-responsive', get_template_directory_uri() . '/assets/css/responsive.css', array(), '1.0' );
    ...
    wp_enqueue_script( 'main-js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '20120206', true );
}
add_action('wp_enqueue_scripts', 'theme_name_theme_files'); 
